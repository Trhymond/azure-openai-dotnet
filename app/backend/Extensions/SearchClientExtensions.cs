...
internal static class SearchClientExtensions
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        SearchOptions searchOption = useSemanticRanker
            ...
            {
                Filter = filter,
                QueryType = SearchQueryType.Semantic, //"semantic"
                QueryLanguage = "en-us",
                QuerySpeller = "lexicon",
                SemanticConfigurationName = "default",
                Size = top,
                QueryCaption = useSemanticCaptions ? QueryCaptionType.Extractive : QueryCaptionType.None, // "extractive|highlight-false"
            }
            : new SearchOptions
            {
                Filter = filter,
